...
#
# Examples:
#   bash scripts/sampling/main/run_sample_sweep_full.sh
#   PLAN_ONLY=true bash scripts/sampling/main/run_sample_sweep_full.sh
...
if (( $# > 0 )); then
    echo "Usage: bash scripts/sampling/main/run_sample_sweep_full.sh" >&2
    exit 2
fi
...
TASK_LIST="${TASK_LIST:-forward inverse}"
