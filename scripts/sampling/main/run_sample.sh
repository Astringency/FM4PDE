...
#
# 用法:
#   PDE=poisson TASK=both bash scripts/sampling/main/run_sample.sh
#   PDE=poisson TASK=forward SAMPLER_PHASE=deterministic bash scripts/sampling/main/run_sample.sh
#   PDE=helmholtz TASK=inverse NUM_STEPS=1000 NUM_OBS=500 BATCH_SIZE=10 bash scripts/sampling/main/run_sample.sh
#
# 环境变量:
